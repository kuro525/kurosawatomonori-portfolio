...
<style scoped lang="scss">
    ...
    /*.grid {*/
        /*display: grid;*/
        /*grid-template: "header" 330px "nav" 50px "section" 1fr "footer" 100px*/
                   /*/ 1fr;*/
        ...
        nav {
            ...
            ul {
                ...
                li {
                    ...
                    .active {
                        border-bottom: solid 3px #ffd891;
                        color: #000;
                        font-weight: bold;
                    ...
                    a {
                        ...
                        &:hover .en {
                            opacity: 0; // aにホバーしたとき英語表記は透明に
                        }

                        &:hover .ja {
                            opacity: 1; //aにホバーしたとき日本語表記を表示
                        }
                    }
                }
            }
